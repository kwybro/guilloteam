  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 gap-10 z-10">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <button
            type="button"
            onClick={handleCopy}
            className="group flex items-center gap-3 bg-white/4 hover:bg-white/7 border border-white/8 hover:border-white/14 rounded-lg px-5 py-3 font-mono text-sm text-white/70 hover:text-white transition-all cursor-pointer z-10"
          >
            <span>{INSTALL_CMD}</span>
            <span className="text-white/30 group-hover:text-white/60 transition-colors text-xs shrink-0">
              {copied ? '✓ copied' : 'copy'}
            </span>
          </button>
        </div>
      ...
      <footer className="flex items-center justify-center px-8 py-5 border-t border-white/6 text-white/25 text-xs gap-6 font-mono">
        ...
        <a href="https://docs.guillo.team" className="hover:text-white/50 transition-colors">docs</a>
        <a href="https://github.com/kwybro/guilloteam/" target="_blank" rel="noopener noreferrer" className="hover:text-white/50 transition-colors">github</a>
      </footer>
